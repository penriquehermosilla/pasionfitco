...
<head>
    <meta charset="UTF-8">
    <meta name="description" content="Kangoo Jumps en Caleta Olivia, Argentina">
    <meta name="keywords" content="Kangoo Jumps, Kangoo Dance, Botas de Rebote, Bounce, Deportes en Caleta Olivia, Actividad Física en Caleta Olivia, Kangoo Jumps en Caleta Olivia, Saltarines en Caleta Olivia">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <meta http-equiv="X-UA-Compatible" content="ie=edge">
    <title>Pasión Fit</title>
...
<body>
    ...
    <div class="offcanvas-menu">
        <div class="offcanvas__logo">
            <a href="#"><img src="img/logo.png" alt="Logo de Pasión Fit"  style="max-height: 70px; margin-bottom: 40px;"></a>
        </div>
        <div id="mobile-menu-wrap"></div>
        <div class="offcanvas__widget">
            <ul>
                <li>| Instructora Judith |</li>
            </ul>
        </div>
    </div>
    <!-- Offcanvas Menu End -->
                ...
                <div class="row">
                    ...
                    <div class="col-lg-9 col-md-9">
                        <div class="header__top__widget">
                            <ul>
                                <li>| Instructora Judith |</li>
                                <li>Llamame: +549 <?php echo $celular;?></li>
                            </ul>
                            <a href="https://wa.me/549<?php echo $celular;?>?text=Hola%20quiero%20hacer%20una%20consulta%20por%20las%20clases%20de%20kangoo%20en%20pasion%20fit" target="_blank" class="primary-btn">Whatsapp</a>
                        </div>
                    </div>
                </div>
    ...
    <section class="hero">
        <div class="hero__sliders owl-carousel">
            <div class="hero__items set-bg" data-setbg="img/hero/background-pg-inicio.jpeg">
                <div class="container">
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="hero__text">
                                <span>Clases de Kangoo Jumps</span>
                                <h2>Disfruta de la pasión del salto</h2>
                                <a href="#" class="primary-btn">Contactame</a>
                            </div>
                        </div>
                    </div>
                </div>
            </div>
            <div class="hero__items set-bg" data-setbg="img/hero/background-pg-inicio2.jpeg">
                <div class="container">
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="hero__text">
                                <span>Vení a Saltar</span>
                                <h2>en Caleta Olivia</h2>
                                <a href="#" class="primary-btn">Contactame</a>
                            </div>
                        </div>
                    </div>
    ...
    <!-- About Section Begin -->
    <section class="home-about spad" style="background-image: url('img/patrones/Paaatterns/PNG/Waimakariri.png');">
        <div class="container">
            <div class="row">
            

                <div class="col-lg-5">
                    <div class="home__about__text text-center">
                        <div class="section-title">
                            <i class="fa fa-heart text-danger" style="font-size: 30px"></i>
                            <h2 class="text-fondo">¿Qué es Kangoo Jumps?</h2>
                        </div>
                        <span class="text-fondo">Kangoo Jumps es un tipo de actividad física basada en el salto con botas de rebote.</span>
                        <p class="text-fondo">Si buscas ejercitarte, tonificar, perder calorías y mejorar tu condición física, esto es para vos. Además es una actividad super divertida en la que saltamos, bailamos y la pasamos super bien.</p>
                    </div>
                </div>
                <div class="col-lg-7">
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="section-title">
                    <i class="fa fa-heart text-danger" style="font-size: 30px"></i>
                        <h2>Beneficios de Kangoo Jumps</h2>
                        <h4>Con las botas de rebote mejorarás tu bienestar general y fortalecerás tu:</h4>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="row justify-content-center text-center">
                    <div class="col-xl-2 col-md-4 col-sm-6">
                        <div class="services__item">
                            ...
                            <h5>Cerebro</h5>
                            <p  class="services__item__text">Ayuda a combatir la depresión, incrementa el potencial cerebral, equilibrio y coordinación.</p>
                        </div>
                    </div>
                    <div class="col-xl-2 col-md-4 col-sm-6">
                        <div class="services__item">
                            ...
                            <h5>Pulmones</h5>
                            <p  class="services__item__text">Incrementa la resistencia pulmonar.</p>
                        </div>
                    </div>
                    <div class="col-xl-2 col-md-4 col-sm-6">
                        <div class="services__item">
                            ...
                            <h5>Corazón</h5>
                            <p  class="services__item__text">Disminuye la presión e incrementa la actividad cardiovascular.</p>
                        </div>
                    </div>
                    <div class="col-xl-2 col-md-4 col-sm-6">
                        <div class="services__item">
                            ...
                            <h5>Defensas</h5>
                            <p class="services__item__text">Estimula el sistema inmunológico.</p>
                        </div>
                    </div>
                    <div class="col-xl-2 col-md-4 col-sm-6">
                        <div class="services__item">
                            ...
                            <h5>Fuerza</h5>
                            <p class="services__item__text">Incrementa la densidad ósea y muscular.</p>
                        </div>
                    </div>
                    <div class="col-xl-2 col-md-4 col-sm-6">
                        <div class="services__item">
                            <img src="img/services/services-6.png" alt="">
                            <h5>Estar en Forma</h5>
                            <p class="services__item__text">Acelera la pérdida de peso quema de 1000 a 1200 cal. por sesión.</p>
                        </div>
                    </div>
                    <div class="col-xl-2 col-md-4 col-sm-6">
                        <div class="services__item">
                            ...
                            <h5>Columna</h5>
                            <p class="services__item__text">Fortalece la columna vertebral.</p>
                        </div>
                    </div>
                    <div class="col-xl-2 col-md-4 col-sm-6">
                        <div class="services__item">
                            ...
                            <p class="services__item__text">Reduce el impacto en articulaciones un 80%.</p>
                        </div>
                    </div>
                </div>
            </div>
